...
@Component({
  selector: 'app-severity3',
  templateUrl: './severity3.component.html',
  styleUrls: ['./severity3.component.scss']
})
export class Severity3Component implements OnInit {
  ...
  tableData: { catname: string; noOfemp: number }[] = [
    { catname: '$30 Insta Cart', noOfemp: 1 },
    { catname: '$30 LYFT Credits', noOfemp: 1 },
  ];
  cat1 = [
